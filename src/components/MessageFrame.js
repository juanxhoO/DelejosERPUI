      ...
      <Card>
        <MDBox p={3}>
          ...
          <MDBox pd={3}>
            ...
            <Typography>
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris tempus, massa
              porttitor volutpat dignissim, ex lorem blandit risus, vitae egestas quam nunc in
              risus.{" "}
            </Typography>
          </MDBox>
        </MDBox>
